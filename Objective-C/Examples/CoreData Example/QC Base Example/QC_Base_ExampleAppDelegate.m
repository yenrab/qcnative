...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[aQuickConnect mapCommandToDCO:@"add" withObject:[AddUserBCO class]];
     ...
     */
	[aQuickConnect mapCommandToDCO:@"query" withObject:[GetUsersBCO class]];
	...
	[aQuickConnect mapCommandToDCO:@"requestHtml" withObject:[GetRequestBCO class]];
